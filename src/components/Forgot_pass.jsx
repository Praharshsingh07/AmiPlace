...
const Forgot_pass = () => {
  ...
  return (
    <>
      <div className="min-h-screen flex justify-center items-center p-3 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2 rounded-xl max-w-screen-lg w-full">
